...
const ACHIEVEMENT_CATALOG = [
  ...
  },
  {
    code: 'TYPING_FIRST',
    title: 'First Test',
    description: 'Earn your first Typing XP',
    icon: 'keyboard',
    category: 'typing',
    criteria: { type: 'moduleXp', module: 'typing', value: 10 },
    xpReward: 20,
  },
  {
    code: 'TYPING_100',
    title: 'Programming Master',
    description: 'Earn 100 XP in Typing',
    icon: 'code',
    category: 'typing',
    criteria: { type: 'moduleXp', module: 'typing', value: 100 },
    xpReward: 50,
  },
  {
    code: 'XP_500',
